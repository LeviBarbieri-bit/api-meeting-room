...
RSpec.describe "Schedules", type: :request do
    ...
    describe "put update" do
        it "returns a 200" do
           ...
           put '/schedules/update', :params => { schedule: '2021-03-30T19:29:13.079-03:00', description: "loren ipsun", id: 8, user_id: 1 },  headers:  { 'Authorization': "Bearer #{TOKEN}" }
    ...
    describe "put update" do
        it "returns user does not exist" do
           ...
           put '/schedules/update', :params => { schedule: '2021-03-30T19:29:13.079-03:00', description: "loren ipsun", id: 6, user_id: 1 },  headers:  { 'Authorization': "Bearer #{TOKEN}" }
